...
Template.resourcesPostSubmit.events({
	...
	'submit form': function(e, template) {
		...
		Meteor.call('postInsert', {author: author, body: body, title: title, spaceId: spaceId, type: "resource", fileId: fileId, fileExt: fileExt, category: category}, function(error, postId) {
			if (error){
